...
START
  ...
  3. Use Open MIDI, drag files into the window, or load the built-in demo.

Keep the EXE and the app, runtime and ui folders together. No installation is
required. Exports are saved in Music\MIDI Voyager Exports. If the application
...
SUPPORTED WORKFLOWS
  ...
  - SF2, SF3 and DLS sound-bank loading
...
NOTES
  - This portable build targets 64-bit Windows 10/11.
